# r-ppm-install Specification

## Purpose
Defines how `scripts/install-tools.sh` configures R and pak for PPM binary package installation, ensuring pre-built Ubuntu 24.04 binaries are served instead of source tarballs on every CI/CD run.
