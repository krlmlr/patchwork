# game-logger Specification

## Purpose
Defines the NDJSON game event logging system that records complete game histories including game-start, move, and game-end events.
