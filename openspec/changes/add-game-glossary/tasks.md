...
- [ ] 1.3 Add Game Rules terms from the design: patch, patch circle, time track, time token, quilt board, button cost, time cost, button income, button balance, income phase (alias: payout), leather (also: leather patch), marker (also: circle marker), buy window, advance move, buy move, bonus tile, active player, starting player, turn order, patch gain, scoring
