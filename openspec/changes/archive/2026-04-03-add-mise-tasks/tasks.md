...
- [x] 1.5 Add a `[tasks.codegen]` entry with `description = "Regenerate committed C++ headers from data files"` and `run = "Rscript codegen/generate_patches.R"`
- [x] 1.6 Verify the file is valid TOML (no syntax errors)
