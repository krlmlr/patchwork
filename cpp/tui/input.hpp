...
using Command = std::variant<BuyPatchCmd, AdvanceCmd, UndoCmd, RedoCmd, ScrollLogLeft,
                             ScrollLogRight, ToggleLogWrap, NdjsonToggleMinimize, NdjsonMaximize,
                             NdjsonSemiMaximize, NdjsonDecrLines, NdjsonIncrLines, QuitCmd>;
